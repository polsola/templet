...
function u_add_product_description() {
	get_template_part( 'template-parts/ecommerce/single/description' );
	do_action('u_after_product_description');
}
add_action('woocommerce_after_single_product_summary', 'u_add_product_description', 12);
